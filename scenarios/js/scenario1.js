// Scenario 1: Chevy Trucks - Answer is "misleading"
...
document.querySelectorAll('button[data-answer]').forEach(function(button) {
  button.addEventListener('click', function() {
    ...
    var continueLink = document.querySelector('#continue a');
        ...
        continueLink.href = 'scenario1-find.html'; // Go to find page
      } else {
        ...
        continueLink.href = 'scenario1-find.html'; // Still go to find page to learn
      }
