// Scenario 8 Find - Inverted Y-axis Problem - Answer is "A"
...
document.querySelectorAll('[data-option]').forEach(function(option) {
  option.addEventListener('click', function() {
    ...
    if (isCorrect) {
      ...
      feedbackText.textContent = 'Not quite! The problem is the Y-axis orientation (A). For rankings, 1st place is BEST and should be at the TOP. This chart has higher numbers (worse ranks) at the top, so when Ireland IMPROVED from 64th to 14th, the line goes DOWN - making success look like failure. The Y-axis should be inverted!';
    }
